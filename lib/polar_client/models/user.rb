  ...
  class User
    ...
    def self.openapi_types
      {
        ...
        weight: :Float,
        height: :Float,
        extra_info: :"Array<UserExtraInfo>"
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `PolarClient::User` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PolarClient::User`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(other)
      ...
      self.class == other.class &&
        polar_user_id == other.polar_user_id &&
        member_id == other.member_id &&
        registration_date == other.registration_date &&
    ...
    def hash
      [polar_user_id, member_id, registration_date, first_name, last_name, birthdate, gender, weight, height, extra_info].hash
    end
