...
module PolarClient
  class WebhooksApi
    ...
    # @param webhook_id [String] Webhook id to update
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def v3_webhooks_activate_get(opts = {})
      v3_webhooks_activate_get_with_http_info(opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def v3_webhooks_activate_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: WebhooksApi.v3_webhooks_activate_get ..."
      end
      # resource path
      local_var_path = "/v3/webhooks/activate"
      ...
      new_options = opts.merge(
        operation: :"WebhooksApi.v3_webhooks_activate_get",
        header_params: header_params,
        query_params: query_params,
        form_params: form_params,
        body: post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhooksApi#v3_webhooks_activate_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def v3_webhooks_deactivate_get(opts = {})
      v3_webhooks_deactivate_get_with_http_info(opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def v3_webhooks_deactivate_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: WebhooksApi.v3_webhooks_deactivate_get ..."
      end
      # resource path
      local_var_path = "/v3/webhooks/deactivate"
      ...
      new_options = opts.merge(
        operation: :"WebhooksApi.v3_webhooks_deactivate_get",
        header_params: header_params,
        query_params: query_params,
        form_params: form_params,
        body: post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhooksApi#v3_webhooks_deactivate_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
  end
