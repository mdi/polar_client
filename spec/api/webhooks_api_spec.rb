...
# Unit tests for PolarClient::WebhooksApi
...
describe "WebhooksApi" do
  ...
  describe "test an instance of WebhooksApi" do
    it "should create an instance of WebhooksApi" do
      expect(@api_instance).to be_instance_of(PolarClient::WebhooksApi)
    end
  end
  ...
  # unit tests for v3_webhooks_activate_get
  # Activate webhook
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe "v3_webhooks_activate_get test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for v3_webhooks_deactivate_get
  # Deactivate webhook
  # Deactivate activated webhook. Deactivated webhook does not push notifications about subscribed events.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe "v3_webhooks_deactivate_get test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
